...
class RibbonManager {
  ...
  void addRibbon() {
    ...
    for (int i = 0; i < ribbonAmount; i++) {
      color ribbonColor = color(250,100,50);
...
class RibbonParticle {
  ...
  float lcx1, lcx2 = v1.x;                  // NEXT FOUR LINES IMPORTANT
  float lcy1, lcy2 = v1.y;                  // SO THAT RIBBONS DONT BEGIN AT 0,0
  float rcx1, rcx2 = v1.x;                  //
  float rcy1, rcy2 = v1.y;                  //
